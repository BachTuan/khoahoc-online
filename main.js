document.getElementById("login-res").innerHTML = '<div id="dangnhap"> <form action="" id="form-dangnhap"> <p>Bạn cần đăng nhập để truy cập khóa học, nếu chưa có tài khoản hãy bấm vào <span style="cursor:pointer;color:blue;font-weight:bold;" onclick="dangkyshow(),dangnhaphide()">ĐĂNG KÝ TÀI KHOẢN</span> </p> <div> <h2>ĐĂNG NHẬP TÀI KHOẢN</h2> </div> <input type="text" name="email" placeholder="Email" class="nhapvao" id="email-login"/><br/> <input type="password" name="password" placeholder="Mật khẩu" class="nhapvao" /><br/> <input type="checkbox" name="ghinho" id="ghinho"/><label for="ghinho">Ghi nhớ tài khoản</label><i style="margin:30px;">Quên Mật Khẩu?</i><br/> <input type="submit" value="ĐĂNG NHẬP" class="nutbam"></input><input type="button" class="nutbam" value="ĐÓNG LẠI" onclick="dangnhaphide()"></input><div class="fb-gg" style="background:#0d47a1;">Đăng nhập với Facebook</div><div class="fb-gg" style="background:#c62828;">Đăng nhập với Google</div> </form> </div> <div id="dangky"> <form> <div> <h2>ĐĂNG KÝ TÀI KHOẢN</h2> </div> <input type="text" name="họ tên" placeholder="Họ Và Tên" class="nhapvao" id="hoten" /><br> <input type="email" name="email" placeholder="Email" class="nhapvao" id="email-dangky"/><br/> <input type="password" name="password" placeholder="Mật khẩu" class="nhapvao" id="pass-dangky" /><br/> <input type="password" name="password" placeholder="Nhập lại mật khẩu" class="nhapvao" id="re-pass-dangky" /><br/> <input type="text" name="sodienthoai" placeholder="Số điện thoại" class="nhapvao" /><br/><br/> <input type="button" value="ĐĂNG KÝ" class="nutbam" onclick="dangky()"></input><input type="button" class="nutbam" value="ĐÓNG LẠI" onclick="dangkyhide()"></input> </form>'
...
function animategiangvien() {
	...
	$('.giangvien').css('-webkit-animation','giangvienanimate 2s ease');
};
